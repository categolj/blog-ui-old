...
import am.ik.blog.ui.BlogUiController;
import lombok.Data;
...
public class PaginationRenderer {
    ...
    public String render(BlogUiController.Page page) throws UnsupportedEncodingException {
        return new Pager(page).render();
    }

    @Data
    static class Pager {
        private final BlogUiController.Page page;
